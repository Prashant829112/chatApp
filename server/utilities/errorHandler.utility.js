...
// -> this utility creates an error object which can be passed to errorMiddleware, without this also, err.Message and err.StatusCode could be
// passed, but this helps avoid writing "message" and "statusCode" again and again in controller's next()
...
// -> stack trace -> js tells the source of error whenever an error is thrown
